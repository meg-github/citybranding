...
def main():
    ...
    # ストップワードの処理
    add_stopword = st.text_input(label="ここでは分析の対象から除く単語を設定することができます．「もの」や「する」など，日常でも頻繁に使われる単語を対象外にすることで，入力した文章の特徴を観察することができます．下の枠に語を設定し，「追加」ボタンで追加できます．「削除」を押すとリストが空になります")
